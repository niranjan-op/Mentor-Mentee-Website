# Generated by Django 5.1.5 on 2025-03-31 13:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField(help_text='Enter your full address', max_length=500)),
                ('phone_no_student', models.CharField(help_text='Enter your phone number', max_length=12)),
                ('phone_no_mother', models.CharField(help_text="Enter your mother's phone number", max_length=12)),
                ('phone_no_father', models.CharField(help_text="Enter your father's phone number", max_length=12)),
                ...
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='students', to='core.mentor')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
